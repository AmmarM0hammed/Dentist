@extends("admin.layout.main" , ["title" => "Request"])
             ...
             <td ><p class=" transition-all  break-words truncate hover:whitespace-normal hover:text-clip w-40 ">{{$appoenmit->bio}}<p></td>
              ...
              <th>
                ...
                <div class="flex space-x-1">
                    <form method="POST" action="{{route('admin.request.done')}}">
                        @csrf                
                    ...
                    <label for="my-modal-6" class="btn btn-error btn-xs mt-[0.10rem]">Delete</label>
                    ...
                    <input type="checkbox" id="my-modal-6" class="modal-toggle" />
                        ...
                        <div class="modal-box">
                            ...
                            <form method="POST" action="{{route('admin.request.delete')}}">
                                @csrf                
                                <input value="{{$appoenmit->id}}" name="id"  hidden>
